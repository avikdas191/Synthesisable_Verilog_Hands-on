...
//	SevSeg SevSeg_1 ( .HEX_2_disp (Dig1), .segments (HEX0) );
//	SevSeg SevSeg_2 ( .HEX_2_disp (Dig2), .segments (HEX1) );
//	SevSeg SevSeg_3 ( .HEX_2_disp (Dig3), .segments (HEX2) );
//
//	// convert the C code, given in the lab sheet, 
//	//	into Verilog code below (three lines)		
//	assign Dig3 = SW / 100; 
//	assign Dig2 = (SW - Dig3*100) /10;
//	assign Dig1 = SW - Dig3*100 - Dig2*10;
...
//		rSW <= SW;
//		rDig3 <= rSW / 100;
//		rDig2 <= (rSW - rDig3*100) /10;
//		rDig1 <= rSW - rDig3*100 - rDig2*10;
//	end
//	
//	reg [3:0] rDig3, rDig2, rDig1;
