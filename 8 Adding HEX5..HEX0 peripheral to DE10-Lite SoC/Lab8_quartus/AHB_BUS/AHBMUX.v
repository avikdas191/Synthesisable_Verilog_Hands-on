...
// massive resources are required when synthetised from the LEs
...
module AHBMUX(
  ...
  //READYOUT FROM ALL THE PERIPHERALS  
  ...
  //MULTIPLEXED HREADY & HRDATA TO THE HOST
  output reg HREADY,
  ...
  begin
    case(APHASE_MUX_SEL)
      4'b0000: begin						// SELECT PERIPHERAL0 RESPONSE & DATA IF PREVIOUS APHASE WAS FOR S0
        HRDATA = HRDATA_S0;
        HREADY = HREADYOUT_S0;
      end
      4'b0001: begin
